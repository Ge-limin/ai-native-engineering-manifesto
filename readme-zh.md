...
2. 你的代码库、文档库、会议纪要、会议录音、团队的记忆、直觉都不是项目真正可依赖的核心资产，唯一可依赖的核心资产有且只有你的测试案例库

3. 理解AI的关键在于理解**无状态性**

4. 我们可以容忍AI犯错错误，只要它不会在下一次模型迭代前杀死我们

5. 软件的复杂度需要从垂直转为水平

6. AI的context window 的上限，将是新时代程序员最需要关心的资源。

7. Plan–Act、Test–Code、Doc–Code–Doc 是新工程时代的工程循环
...
11. AI IDE或AI Agent 卖的是Context选择的能力。
