...
- [*SSOT 是软件工程的根原则*](chapters-zh/14-ssot-as-the-root-principle-zh.md)（连接真相 2、3、7、11；[含图完整版](https://liminge.space/cn/blog/ssot-nine-layer-pyramid)）
- [*SSOT 九层金字塔模型*](chapters-zh/15-ssot-nine-layer-pyramid-model-zh.md)（连接真相 2、3、7、11；[含图完整版](https://liminge.space/cn/blog/nine-layer-pyramid-principles)）
