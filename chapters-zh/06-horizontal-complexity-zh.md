...
> 延伸阅读：用户故事如何作为水平复杂度的天然切分单位，参见[*AI Coding 的五个等级与 User Story Driven 终局*](./09-ai-coding-levels-and-user-story-driven-zh.md)。小团队在实施这一转型时的优势，参见[*AI-Native 小团队的结构性优势*](./10-small-team-advantage-zh.md)。
...
AI 的上下文窗口是有限的，这一点在[*AI 的无状态性与 Context Window*](./01-ai-statelessness-and-context-window-zh.md)中已经展开。结合这一点来看复杂度：
