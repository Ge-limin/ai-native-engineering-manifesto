...
| L4 Flow | 所有利益相关方如何完成真实任务？ | 用户、AI agent、发布 operator、产品、研发、客服/支持、发布流程 |
...
对非开发同事来说，Flow 同样关键。产品、运营、销售、客服/支持通常从场景、交接、失败路径和 evidence 理解系统，而不是从组件调用关系理解系统。Flow 给他们一张共同地图。

### 6. 每个专题文档都要声明归属

架构、运维、工作计划、测试、UI、安全、客服/支持文档都可以保留自己的结构。
...
6. 收敛测试、发布、运维入口。
7. 给产品、运营、销售、客服/支持一条进入承诺、Flow 和 evidence 的路径。
8. 让 AI agent 自顶向下阅读。
9. 让 AI agent 自底向上更新。
10. 删除或压缩已完成计划。
11. 语义变化时同步改名。
